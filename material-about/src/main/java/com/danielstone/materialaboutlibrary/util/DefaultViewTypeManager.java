...
import static com.danielstone.materialaboutlibrary.util.DefaultViewTypeManager.ItemLayout.ACTION_SWITCH_ITEM_LAYOUT;
...
public class DefaultViewTypeManager extends ViewTypeManager {
    ...
    public static final class ItemLayout {
        ...
        public static final int ACTION_SWITCH_ITEM_LAYOUT = ViewTypeManager.ItemLayout.ACTION_SWITCH_LAYOUT;
    ...
    public int getLayout(int itemType) {
        switch (itemType) {
            ...
            case ACTION_SWITCH_ITEM:
                return ACTION_SWITCH_ITEM_LAYOUT;
